...
if __name__ == "__main__":
    city = "New York"
    conn_str = 'Endpoint=sb://streamingeventhubnamespace.servicebus.windows.net/;SharedAccessKeyName=streamingpolicy;SharedAccessKey=jLsmEQBqzbN4G6wB/96sk/NoppvB5DoTp+AEhCUatbQ=;EntityPath=streamingeventhubs'
    eventhub_name = 'streamingeventhubs'
